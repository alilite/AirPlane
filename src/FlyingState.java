...
public class FlyingState implements AircraftState{
    private IAircraft aircraft;
    public FlyingState(IAircraft aircraft) {
    ...
    public void startEngine() {
        System.out.println("Cannot start engine, " + aircraft.getReference() + " is flying");
    }

    @Override
    public void stopEngine() {
        System.out.println("Cannot stop engine, " + aircraft.getReference() + " is flying");
    }
    ...
    public void landingMode() {
        this.aircraft.setAircraftState(this.aircraft.getLandingState());
        System.out.println(aircraft.getReference() + " has entered landing mode");
    }

    @Override
    public void land() {
        System.out.println(aircraft.getReference() + " exploded due to attempt to land outside of landing mode");
        explode();
    }
    ...
    public void explode() {
        ...
        System.out.println(aircraft.getReference() + " has exploded");
    }
